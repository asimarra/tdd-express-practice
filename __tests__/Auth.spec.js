...
describe('Authentication', () => {
  ...
  it.each([
    { language: 'en', message: 'Incorrect credentials' },
    { language: 'es', message: 'Credenciales invalidas' },
  ])(
    'should return $message when authentication fails and language is set as $language',
